  ...
  \begin{scope}[shift={(2.72,1.25)},x=0.55cm,y=0.40cm]
    ...
    \foreach \y in {-2,2,6}
      \draw[line width=0.55pt] (-4.5,\y) -- ++(0.16,0)
        node[left=1pt] {$\y$};
    \node[below=8pt,font=\small] at (0,-3.0) {$a$};
    \node[rotate=90,anchor=south,font=\small] at (-5.35,2.0) {$b$};
